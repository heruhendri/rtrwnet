...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("INSERT INTO ftth_pop (nama_pop, lokasi, latitude, longitude, alamat_lengkap, kapasitas_olt, status, pic_nama, pic_telepon, keterangan) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssddsissss", $nama_pop, $lokasi, $latitude, $longitude, $alamat_lengkap, $kapasitas_olt, $status, $pic_nama, $pic_telepon, $keterangan);
    
    if ($stmt->execute()) {
        echo "<script>alert('POP berhasil ditambahkan'); window.location.href='data_pop.php';</script>";
        exit;
    } else {
...
<main class="main-content" id="mainContent">
    <div class="page-title">
        <h1>Tambah POP Baru</h1>
        <div class="page-subtitle">Tambah Point of Presence untuk infrastruktur FTTH</div>
    </div>
            ...
            <form method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="kapasitas_olt" class="form-control" required min="1" value="5">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-save"></i> Simpan POP
                    </button>
                    <a href="data_pop.php" class="btn btn-secondary">
